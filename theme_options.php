...
$categories_tmp = array_unshift($zm_categories, "Selecciones una Categoria:");	

$options = array (

	array(  "name" => "Opciones de Pagina",
            "type" => "title",
			"desc" => "",
        ),
	...
	array(  "name" => "Contenido de la Pagina",
			"desc" => "Elige entre los anuncios de propiedad o entradas de blog para mostrar en la página principal",
			"id" => $shortname."_home",
            "type" => "select",		
    ...
    array(  "name" => "Slider con los anuncios destacados",
            "type" => "title",
			"desc" => "",
       		),
	...
	array( 	"name" => "Numero de artículos destacados",
			"desc" => "Ajuste el número de diapositivas destacadas.",
    ...
    array(  "name" => "Detalles de Contacto",
            "type" => "title",
			"desc" => "",
       		),
	...
	array( 	"name" => "Número de teléfono de la empresa",
			"desc" => "Introduzca el número de teléfono de la empresa.",
			"id" => $shortname."_my_phone",
			"std" => "",
            "type" => "text"), 		
			
	array( 	"name" => "Email de contacto",
			"desc" => "Ingrese el email de Contacto.",
