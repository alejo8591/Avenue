...
<div class="inpanel">
	...
	<div class="spropmeta">
<h3><?php the_title(); ?></h3>
	<div class="sproplist"><span>Ubicación</span> <span class="propval"> <?php echo get_the_term_list( $post->ID, 'location', '', ' ', '' ); ?></span></div>
	...
	<div class="sproplist"><span>Cuartos</span> <span class="propval"> <?php echo get_the_term_list( $post->ID, 'bedrooms', '', ' ', '' ); ?></span></div>
	<div class="sproplist"><span>Baños</span> <span class="propval"> <?php $bath=get_post_meta($post->ID, 'wtf_bath', true); echo $bath; ?></span></div>
	<div class="sproplist"><span>Garaje</span> <span class="propval"> <?php $garage=get_post_meta($post->ID, 'wtf_garage', true); echo $garage; ?></span></div>
